...
def suppliers_list():
    ...
    return render_template(
        "suppliers/suppliers_list.html", suppliers=suppliers, search=search
    )
...
def add_supplier():
    ...
    if request.method == "POST":
        try:
            ...
            return redirect(
                url_for("suppliers.supplier_detail", supplier_id=supplier.id)
            )
...
def edit_supplier(supplier_id):
    ...
    if request.method == "POST":
        try:
            supplier.supplier_name = request.form.get(
            ...
            supplier.payment_terms = request.form.get(
            ...
            return redirect(
                url_for("suppliers.supplier_detail", supplier_id=supplier_id)
            )
...
def supplier_ledger():
    ...
    suppliers = (
        db.session.query(
            ...
            func.sum(
                db.case(
                    (Purchase.payment_status != "paid", Purchase.total_amount), else_=0
                )
